...
class progress {
        ...
        var $empresa = null;
        var $proginicial = "";
        var $service_port = 23401;
        var $address = 'localhost';
        var $socket = false;
        var $entrada = "";

        function setendereco($address){
            $this->address = $address;
        }
        function setporta($service_port){
            $this->service_port = $service_port;
        }
        function setsocket($viasocket){
            $this->socket = $viasocket;
        }
        function setempresa($empresa){
            $this->empresa = $empresa;
            //echo "progress_class setempresa empresa=".$this->empresa."\n";
        }
...
*/
        ...
        function socket ($address=null,$service_port=null) {
        
            $this->ambiente();
            $entrada = $this->entrada;
            $executa = $this->acao;
            $inicial = $this->proginicial;
            $tmp = $this->tmp;
