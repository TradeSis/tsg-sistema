...
then do:
    create ttsaida.
    ttsaida.tstatus = 400.
    ttsaida.descricaoStatus = "login aplicativo nao encontrado".
...
do on error undo:
    find loginaplicativo where loginaplicativo.idLogin = ttentrada.idLogin AND loginaplicativo.idAplicativo = ttentrada.idAplicativo exclusive no-error.
    loginaplicativo.nivelMenu = ttentrada.nivelMenu. 
end.

create ttsaida.
ttsaida.tstatus = 200.
ttsaida.descricaoStatus = "login aplicativo alterado com sucesso".
