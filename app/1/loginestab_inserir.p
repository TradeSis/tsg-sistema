...
then do:
    create ttsaida.
    ttsaida.tstatus = 400.
    ttsaida.descricaoStatus = "loginestab ja cadastrado".
...
do on error undo:
	create loginestab.
	loginestab.idLogin = ttentrada.idLogin.
	loginestab.etbcod = ttentrada.etbcod.
	loginestab.idEmpresa = ttentrada.idEmpresa.

end.

create ttsaida.
ttsaida.tstatus = 200.
ttsaida.descricaoStatus = "loginestab criado com sucesso".
hsaida  = temp-table ttsaida:handle.
